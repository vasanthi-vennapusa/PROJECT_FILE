package phase1Project_assesment;
import java.io.File;
import java.io.IOException;
import java.util.Arrays;
import java.util.Scanner;
public class Phase1project_assesment {

	 static String MY_Dir;
	    File myFolder;

	    public Phase1project_assesment() 
	    {
	    	MY_Dir = System.getProperty("user.dir");
	    	myFolder = new File("C:\\java files");
	        if (!myFolder.exists())
	        	myFolder.mkdirs();
	   ...
	   private static final String The_LOGIC_PART =
	    ...
	    public static void main(String[] args) {
	        ...
	        Phase1project_assesment menu = new Phase1project_assesment();
	        menu.firstView();
	    }
}